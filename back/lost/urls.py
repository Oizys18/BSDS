...
urlpatterns = [
    ...
    path('posting/<int:lost_id>/', views.update_delete_lost, name='update_delete_lost'),
    path('posting/<int:lost_id>/status/', views.update_lost_status, name='update_lost_status'),
